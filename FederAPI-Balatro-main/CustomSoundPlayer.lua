--- STEAMODDED HEADER
--- MOD_NAME: Feder API - Custom Sound Player
--- MOD_ID: FederAPI_CustomSoundPlayer
--- MOD_AUTHOR: [itayfeder]
--- MOD_DESCRIPTION: Part of the Feder API. Adds custom sound player.

----------------------------------------------
------------MOD CODE -------------------------

local MODDED_SOURCES = {}
...
function modded_play_sound(sound_code, stop_previous_instance, volume, pitch)
    ...
    for _, s in pairs(MODDED_SOURCES) do
